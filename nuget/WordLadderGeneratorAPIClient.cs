...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/wordladder";
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WordLadderGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WordLadderGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WordLadderGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(WordLadderGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WordLadderGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WordLadderGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WordLadderGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WordLadderGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WordLadderGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WordLadderGeneratorQueryOptions options)
        {
