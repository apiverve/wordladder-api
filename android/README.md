# Word Ladder Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:wordladder-api:1.1.14'
}
```
...
```java
import com.apiverve.wordladder.WordLadderGeneratorAPIClient;
import com.apiverve.wordladder.APIResponse;
import com.apiverve.wordladder.APIException;

// Initialize the client
WordLadderGeneratorAPIClient client = new WordLadderGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/wordladder](https://docs.apiverve.com/ref/wordladder)
...
- **Documentation:** [https://docs.apiverve.com/ref/wordladder](https://docs.apiverve.com/ref/wordladder)
- **Issues:** [GitHub Issues](https://github.com/apiverve/wordladder-api/issues)
